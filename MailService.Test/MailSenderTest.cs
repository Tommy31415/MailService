...
namespace MailService.Test
{
    public class MailSenderTest
    {
        ...
        public void ShouldSendEmail()
        {
            ...
            mailSender.Send(new Mail(){Body = "test",Id=0,MailStatus = EMailStatus.Pending,Recipients = new List<Recipient>{new Recipient(){Email = "jhon@gmail"}},SenderEmail = "aaa@bbbb",Title = "title"});
